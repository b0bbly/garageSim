...
private float startDuration;
    ...
    void CheckInput()
    {
        ...
        if (!playerControlsEnabled)
        {
            ...
            gasInput = 0;
            steeringInput = 0;
            brakeInput = 1; //TODO: maybe check if I need to remove this to allow the vehicle to roll away if handbrake isn't up?
            return;
        }
        gasInput = Input.GetAxis("Vertical");
        steeringInput = Input.GetAxis("Horizontal");
        Debug.Log(" Engine is running: " + isEngineRunning + ". Gas Input: " + gasInput + ". Brake Input: " + brakeInput + ". Steering Input: " + steeringInput + ".");
/*
        if (Mathf.Abs(gasInput) > 0 && isEngineRunning == 0)
        {
            ...
            if (engineAudio != null)
            {
                engineAudio.isEngineRunning = true;
            }
        }
        */
